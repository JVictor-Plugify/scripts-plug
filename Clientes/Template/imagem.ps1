...
installPackage -PackageList (Get-Content -Path ".\Clientes\ \Packages\Chocolatey\softwares.txt")

#Calling InstallExe function to run .exe or .msi 
installExe -Installer (Get-Content -Path ".\Clientes\ \Packages\Installers\softwares.txt")
